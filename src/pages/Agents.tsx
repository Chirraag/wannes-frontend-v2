...
export function Agents() {
  ...
  const handleCreateAgent = async () => {
    ...
    try {
      ...
      const response = await fetch('https://backend-dig-agents-wannes.replit.app/api/create-agent', {
        method: 'POST',
        headers: {
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h3 className="font-medium">{agent.agent_name || 'Single Prompt Agent'}</h3>
