...
export function KnowledgeBase() {
  ...
  const fetchKnowledgeBases = async () => {
    ...
    try {
      const response = await fetch('https://backend-dig-agents-wannes.replit.app/api/list-knowledge-bases');
  ...
  const handleCreateKnowledgeBase = async () => {
    ...
    try {
      ...
      const response = await fetch('https://backend-dig-agents-wannes.replit.app/api/create-knowledge-base', {
        method: 'POST',
        headers: {
