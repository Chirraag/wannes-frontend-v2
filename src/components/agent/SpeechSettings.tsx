    ...
    <div className="space-y-6 p-4">
      ...
      <div className="space-y-2">
        <div>
          ...
          <p className="text-xs text-gray-500">Control how sensitive AI can be interrupted by human speech</p>
          <div className="flex items-center justify-between">
            <Slider
      ...
      <div className="space-y-2">
        ...
        {showAddPronunciation && (
          <div className="mt-2 p-3 border rounded-lg space-y-3">
            ...
            <div>
              <label className="block text-xs font-medium mb-1">IPA Phoneme</label>
              <input
                type="text"
                value={newPhoneme}
